...
- README.md now clearly identifies this as the OpenClaw skill
...
**Both can coexist** - Shared authentication allows users to install both the OpenClaw skill and MCP server simultaneously.

**This repo is now focused exclusively on the OpenClaw skill** for automated health monitoring, scheduled reports, and proactive check-ins.
...
### Metadata
- Expanded ClawHub description with conversational examples and "talk to your data" messaging
...
**Configuration:**
- UI-configurable via OpenClaw config (`skills.entries.garmin-health-analysis.env`)
...
**Security:**
- Session tokens stored locally in `~/.openclaw/garmin/`
- Tokens auto-refresh
