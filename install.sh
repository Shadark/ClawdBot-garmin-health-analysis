#!/usr/bin/env bash
# Garmin Health Analysis - OpenClaw Skill Installation
# Run this after cloning the skill to your OpenClaw skills directory
...
echo "     - Add to ~/.openclaw/openclaw.json skills config"
echo
echo "  2. Authenticate:"
